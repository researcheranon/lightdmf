...
parser.add_argument('--max_lr', type=float, default=3e-4, help='Maximum learning rate for One Cycle LR scheduler')
...
parser.add_argument('--log_step', type=int, default=100, help='Logging interval in steps')
parser.add_argument('--test_step', type=int, default=100, help='Testing interval in steps')
